...
sap.ui.core.mvc.Controller.extend("GoodsReceipt1.view.Master", {
	...
	loadDetailView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "GoodsReceipt1.view.Detail",
			targetViewType: "XML"
		});
	},
	...
	_createDialog: function(sDialog) {
			...
			var sName = oContext.getProperty("Lgnum");
		...
		fnApplyFiltersAndOrdering: function(oEvent) {
			...
			if (this.bGrouped) {
				aSorters.push(new Sorter("Lgnum", this.bDescending, this._fnGroup));
			} else {
				aSorters.push(new Sorter("Lgnum", this.bDescending));
			}

			if (this.sSearchQuery) {
				var oFilter = new Filter("Lgnum", sap.ui.model.FilterOperator.Contains, this.sSearchQuery);
